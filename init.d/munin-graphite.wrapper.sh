...
export PATH=/server/graphite/ruby/ruby-1.8.7-p352/bin:$PATH:/usr/local/bin
export LD_LIBRARY_PATH=/server/graphite/ruby/ruby-1.8.7-p352/lib/
export GEM_PATH=/usr/local/rvm/gems/ruby-1.8.7-p352
